...
export default function SearchFilters({
  ...
  return (
    <div className="relative">
      ...
      {isVisible && (
        <Card
          className="fixed top-20 right-4 z-[99999] w-80 sm:w-96 max-w-[calc(100vw-2rem)] shadow-2xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-2xl overflow-visible"
          style={{
            position: "fixed",
            zIndex: 99999,
            top: "5rem",
