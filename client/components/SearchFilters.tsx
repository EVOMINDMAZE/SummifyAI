...
export default function SearchFilters({
  ...
  return (
    <div className="relative">
      ...
      {/* Filters Panel */}
      {isVisible && (
        <Card className="absolute top-12 right-0 z-[100] w-80 sm:w-96 max-w-[calc(100vw-2rem)] shadow-xl border-0 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl transform translate-x-0 sm:translate-x-0 md:-translate-x-0">
