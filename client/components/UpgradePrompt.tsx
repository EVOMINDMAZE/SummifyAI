...
export default function UpgradePrompt({
  ...
  const { hasFeature, getUpgradeMessage, getRequiredTier, planType } = useFeatureAccess();
  ...
  return (
    <div className={`bg-gradient-to-r from-[#FFFD63]/10 to-amber-100/50 dark:from-[#FFFD63]/20 dark:to-amber-900/20 rounded-xl p-6 border border-[#FFFD63]/20 ${className}`}>
      <div className="flex items-start gap-4">
        <div className="flex-shrink-0">
          <div className="w-10 h-10 bg-[#FFFD63] rounded-full flex items-center justify-center">
            <svg className="w-5 h-5 text-[#0A0B1E]" fill="currentColor" viewBox="0 0 20 20">
