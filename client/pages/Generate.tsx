                ...
                <div className="bg-white/50 dark:bg-gray-700/50 rounded-xl p-4 mt-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-[#0A0B1E] dark:text-white font-medium">
                      {currentOperation ||
                        "AI is analyzing thousands of chapters..."}
                    </span>
                  </div>
                </div>
              )}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-3 text-sm">
                    <Badge
                      variant="outline"
                      className="border-[#0A0B1E]/20 text-[#0A0B1E] dark:border-[#FFFD63]/20 dark:text-[#FFFD63]"
                    >
                                        ...
                                        <div className="flex items-start gap-2">
                                          ...
                                          <div>
                                            ...
                                            <p className="text-xs text-[#0A0B1E]/80 dark:text-gray-300 line-clamp-2">
                                              {chapter.whyRelevant ||
                                                `This chapter provides direct insights into ${searchResults.query} with practical applications.`}
                                            </p>
                                          </div>
                                        </div>
                                      </div>
                          ...
                          {book.topChapters.length > 3 && (
                            <div className="mt-4 text-center">
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleChapterClick(book, book.topChapters[0])
                                }
