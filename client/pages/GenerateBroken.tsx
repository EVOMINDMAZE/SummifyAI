              ...
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400">
                  ...
                  {generatedSummary.books.reduce(
                    (total, book) =>
                      total + (book.relevantChapters?.length || 0),
                    0,
                  )}{" "}
                  precise chapters across {generatedSummary.books.length} books
                  that address "{generatedSummary.topic}"
                </p>
              </div>
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    onClick={() => {
                      const shareData = {
                        title: `Chapter Analysis: ${generatedSummary.topic}`,
                        text: `I found amazing chapters on ${generatedSummary.topic} using SummifyAI!`,
                    ...
                    className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-purple-600 hover:to-blue-600 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center gap-2"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
