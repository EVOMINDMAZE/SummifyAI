              ...
              {filteredAndSortedResults().length > 0 ? (
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-12 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    No search results match your current filters. Try adjusting your search terms or filters.
                  </p>
                  <button
                    onClick={() => {
                      setSearchQuery('');
            ...
            <div className="space-y-8">
              {filteredAndSortedResults().length > 0 ? (
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No saved summaries found</h3>
                  <p className="text-gray-600 dark:text-gray-400">
                    You haven't saved any summaries yet or none match your current filters.
                  </p>
                </div>
              )}
            </div>
