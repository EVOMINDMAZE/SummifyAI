...
export const handler: Handler = async (event) => {
  ...
  try {
    ...
    if (priceId.startsWith('price_') && !priceId.match(/^price_[A-Za-z0-9]{24,}$/)) {
      return {
        statusCode: 400,
        headers: {
          "Access-Control-Allow-Origin": "*",
        ...
        body: JSON.stringify({
          ...
          instructions: "Create products in your Stripe dashboard and set the correct STRIPE_*_PRICE_ID environment variables."
        }),
      };
    }
