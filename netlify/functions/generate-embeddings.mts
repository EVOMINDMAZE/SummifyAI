...
export default async (req: Request, context: Context) => {
  ...
  try {
    ...
    console.log(`🧠 Netlify Function: Generating embeddings for query: "${query}"`);
    ...
    console.log(`✅ Netlify Function: Embeddings generated successfully (${embedding.length} dimensions)`);
