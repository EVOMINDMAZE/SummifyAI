...
router.post("/analyze", async (req, res) => {
  try {
    ...
    // Use OpenAI to analyze if the topic is too broad
...
[
  {
    ...
    "description": "What they'll discover with this search"
      ...
      try {
        ...
        console.error("Failed to generate refinements:", refinementError);

        // Fallback refinements based on common broad topics
        ...
        refinements = fallbackRefinements[
          topicKey as keyof typeof fallbackRefinements
        ] || [
          {
